...
Shannon values were calculated on filtered 0.03Cluster OTU table for each sample
...
if len(sys.argv)!=5:
    raise Exception ("Useage of alpha_diversity_Shannon_pvalues.py <input shannon value table> <comparison groups list> <R script full path> <ouput pvalue table file>")
...
for line in infh:
    ...
    if count>1:
        ...
        outfh.write("x<-data$ShannonEntropy[data$CohortGroups=='"+x_name+"']\n")
        outfh.write("y<-data$ShannonEntropy[data$CohortGroups=='"+y_name+"']\n")
